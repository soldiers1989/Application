...
public class LongCommentsFragment extends BaseMvpRxFragment<ICommentsView, CommentsPresenter>
        implements ICommentsView {

    private static final String TAG = LongCommentsFragment.class.getSimpleName();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_comments_long;
    }
    ...
    protected void initViews() {
        ...
        mTextMessage.setText(R.string.comment_sofa_message_long);
    }
    ...
    protected void initData() {
        ...
        presenter.getLongCommentsInfo(bindToLifecycle(), id);
    }
