 ...
 * 专栏详细信息实体类
 */
public class SectionsDetailInfo implements Parcelable {
    /**
    ...
    protected SectionsDetailInfo(Parcel in) {
    ...
    public static final Creator<SectionsDetailInfo> CREATOR = new Creator<SectionsDetailInfo>() {
        @Override
        public SectionsDetailInfo createFromParcel(Parcel in) {
            return new SectionsDetailInfo(in);
        }

        @Override
        public SectionsDetailInfo[] newArray(int size) {
            return new SectionsDetailInfo[size];
        }
    };
