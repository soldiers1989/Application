 ...
 * 专栏详细信息实体类
 */
public class SectionDetailsInfo implements Parcelable {
    /**
    ...
    protected SectionDetailsInfo(Parcel in) {
    ...
    public static final Creator<SectionDetailsInfo> CREATOR = new Creator<SectionDetailsInfo>() {
        @Override
        public SectionDetailsInfo createFromParcel(Parcel in) {
            return new SectionDetailsInfo(in);
        }

        @Override
        public SectionDetailsInfo[] newArray(int size) {
            return new SectionDetailsInfo[size];
        }
    };
    ...
    public static class Story implements Parcelable {
        ...
        protected Story(Parcel parcel) {
            ...
            display_date = parcel.readString();
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeByte((byte) (multipic == true ? 1 : 0));
        }
